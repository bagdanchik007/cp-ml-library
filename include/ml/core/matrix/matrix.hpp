 ...
 *
 * Declaration only. Implementations are organized in the operations/
 * directory, which is included at the bottom of this file.
 */
class Matrix {
public:
    // ============================================================
...
#include "operations/matrix_decomposition.hpp"
